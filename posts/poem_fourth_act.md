...
I.e., $S/\_{\sim}$ is a set containing all the equivalence classes; thus the elements of $S/\_{\sim}$ are $[a]$, where $[a]$ denotes an equivalence class represented by $a \in S$.<br>
