...
[3]: You may have heared of the "mysterious" famous <a href="https://en.wikipedia.org/wiki/Hilbert%27s_paradox_of_the_Grand_Hotel" target="_blank" rel="noopener" class="text-blue-600 dark:text-blue-400 hover:underline">Hilbert's Hotel problem</a>. Now, in this thought experiment just replace the hotel rooms with the train wagons and think of the concept of infinity just described. Do you still find it difficult to understand why there is a new room waiting for each new guest that arrives if the hotel has infinitely many rooms? :) 
-->
