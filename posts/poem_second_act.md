...
Already around 300 B.C.[#1], Aristotle stated that _"mathematics is about forms"_ [ref:HusseyAristotlePhysics1993], which in our today's understanding one could also call structures. The intention of this poem is to introduce these structures by flying high above the mountains to understand what structures are in general sense and what types of structures we have (at least according to Bourbaki). This builds on our psychological foundation of the big picture view presented in the [Act 1](post.html?slug=poem_first_act). In the following acts, we will head from the clouds closer to the valley to see some specific examples of structures within the more general types of structures introduced here below.
